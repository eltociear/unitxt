...
def question_answering_preprocess(
    ...
    :param label_index: in what index is the right index (consider using
    IndexOf function if you have the answer instead)
    :param expected_answer: what format should the 'label' field be
    answer\number\number_and_answer
    :return:
    """
    renames = {
